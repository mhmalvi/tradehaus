                        ...
                        <div class="table-responsive">
                            <table id="responsive-data-table" class="table" style="width:100%">
                                ...
                                <tbody>
                                    @php
                                    $id =1;
                                    $order = App\Models\OrderedProducts::where('created_at','%D')->get();
                                    ...
                                    @php
                                    $customers = App\Models\Order::where('id',$item->order_id)->first();
                                    @endphp
                                    <tr>
                                        <td>{{ $id++ }}</td>
                                        <td><img class="product-img tbl-img" src="{{ env('APP_URL').'/'.$item->product_image }}" alt="product"></td>
                                        <td>{{ $item->product_name }}</td>
                                        <td><strong>{{ $customers->first_name.' '.$customers->last_name }}</strong>
                                    ...
                                    @else
                                    <tr>
                                        <td colspan='10' style="text-align:center;margin-top:40px;">
