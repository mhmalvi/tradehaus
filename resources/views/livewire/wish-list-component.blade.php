                                ...
                                <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6 mb-6 pro-gl-content">
                                    <div class="ec-product-inner">
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="product-left-sidebar.html" class="image">
                                                    <img class="main-image" src="{{ asset($product_item->product_image) }}" alt="Product" />

                                                    <img class="hover-image" src="{{ asset($product_item->product_image) }}" alt="Product" />
                                        ...
                                        <div class="ec-pro-content">
                                            ...
                                            <span class="ec-price">
                                                <span class="old-price">${{ $product_item->product_price }}.00</span>
