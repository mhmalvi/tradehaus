            ...
            <div class="ec-shop-rightside col-lg-12 col-md-12">
                ...
                <div class="ec-pro-list-top d-flex">
                    <div class="col-md-6 ec-grid-list">
                        <div class="ec-gl-btn">
                            <button class="btn sidebar-toggle-icon"><img src="assets/images/icons/filter.svg" class="svg_img gl_svg" alt="filter" /></button>
                            <button class="btn btn-grid-50 active"><img src="assets/images/icons/grid.svg" class="svg_img gl_svg" alt="grid" /></button>
                            <button class="btn btn-list-50"><img src="assets/images/icons/list.svg" class="svg_img gl_svg" alt="list" /></button>
                        </div>
                    </div>
                                        ...
                                        <div class="ec-pro-option">
                                            <div class="ec-pro-color">
                                                ...
                                                <ul class="ec-opt-swatch ec-change-img">
                                                    ...
                                                    <li class="active"><a href="#" class="ec-opt-clr-img" data-src="" data-src-hover="" data-tooltip="Gray"><span style="background-color:{{ $product->color_1 }}"></span></a></li>
                                                    <li class="active"><a href="#" class="ec-opt-clr-img" data-src="" data-src-hover="" data-tooltip="Gray"><span style="background-color:{{ $product->color_2 }}"></span></a></li>

                                                    <li class="active"><a href="#" class="ec-opt-clr-img" data-src="" data-src-hover="" data-tooltip="Gray"><span style="background-color:{{ $product->color_3 }}"></span></a></li>

                                                    <li class="active"><a href="#" class="ec-opt-clr-img" data-src="assets/images/product-image/6_1.jpg" data-src-hover="" data-tooltip="Gray"><span style="background-color:{{ $product->color_4 }}"></span></a></li>
