                    ...
                    <div class="col header-top-right d-none d-lg-block">
                        <div class="header-top-right-inner d-flex justify-content-end">
                            ...
                            <div class="ec-header-user dropdown">
                                <button class="dropdown-toggle" data-bs-toggle="dropdown"><img src="assets/images/icons/user_5.svg" class="svg_img top_svg" alt="" /><span class="ec-btn-title">Login</span></button>
                            ...
                            <div class="ec-header-wishlist">
                                <a href="#">
                                    <div class="top-icon"><img src="assets/images/icons/pro_wishlist.svg" class="svg_img top_svg" alt="" /></div>
                        ...
                        <div class="ec_cat_inner">
                            ...
                            <a href="#">
                                ...
                                <div class="ec-cat-image">
                                    <img src="{{ asset(env('APP_URL').'/'.$sub_category->category_image) }}" class="svg_img cat_svg" alt="" />

                                </div>
                                <div class="ec-cat-desc">
                                    <span class="ec-section-title">{{ $sub_category->category_name }}</span>
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 ec-product-content">
                                <div class="ec-product-inner">
                                    ...
                                    <div class="ec-pro-image-outer">
                                        <div class="ec-pro-image" style="height: 288px;">

                                            <a href="product-left-sidebar.html" class="image">
                                                <img class="main-image" src="{{ asset(env('APP_URL').'/'.$product->product_image) }}" alt="Product" />
                                                <img class="hover-image" src="{{ asset(env('APP_URL').'/'.$product->product_image) }}" alt="Product" />
                ...
                <div class="ec-banners">
                    <div class="ec-banner-left col-sm-6">
                        <div class="ec-banner-block ec-banner-block-1 col-sm-12">
                            <div class="banner-block">
                                <img src="assets/images/banner/lenovo_tab.jpg" alt="" />
                    ...
                    <div class="ec-banner-right col-sm-6">
                        <div class="ec-banner-block ec-banner-block-2 col-sm-12">
                            <div class="banner-block">
                                <img style="height: 276px;" src="assets/images/banner/xia.jpg" alt="" />
                    ...
                    <div class="ec-spe-products">
                            ...
                            <div class="ec-fs-pro-inner ec-product-inner">
                                <div class="ec-fs-pro-image-outer col-lg-6 col-md-6 col-sm-6">
                                    <div class="ec-fs-pro-image">
                                        <a href="product-left-sidebar.html" class="image"><img class="main-image" src="assets/images/deals-of-the-days/images.jpg" alt="Product" /></a>
                                    </div>
                                </div>
                        ...
                        <div class="ec-fs-product">
                            <div class="ec-fs-pro-inner ec-product-inner">
                                <div class="ec-fs-pro-image-outer col-lg-6 col-md-6 col-sm-6">
                                    <div class="ec-fs-pro-image">
                                        <a href="product-left-sidebar.html" class="image"><img class="main-image" src="assets/images/deals-of-the-days/wirless_earphone.jpg" alt="Product" /></a>
                        ...
                        <div class="ec-product-content">
                            <div class="ec-product-inner">
                                ...
                                <div class="ec-pro-image-outer">
                                    <div class="ec-pro-image">
                                        <a href="product-left-sidebar.html" class="image">
                                            <img class="main-image" style="height:216px;" src="assets/images/exclusive-products/jbl.jpg" alt="Product" />



                                            <img class="hover-image" style="height:216px;" src="assets/images/exclusive-products/jbl.jpg" alt="Product" />
                                ...
                                <div class="ec-pro-content">
                                    <div class="ec-pro-option">
                                        <div class="ec-pro-opt-inner">
                                            <div class="ec-pro-color">
                                                <ul class="ec-opt-swatch ec-change-img">
                                                    <li class="active"><a href="#" class="ec-opt-clr-img" data-src="assets/images/special-product/3_1.jpg" data-src-hover="assets/images/special-product/3_1.jpg" data-tooltip="Gray"><span style="background-color:#dbdbdb;"></span></a></li>
                                                    <li><a href="#" class="ec-opt-clr-img" data-src="assets/images/special-product/3_2.jpg" data-src-hover="assets/images/special-product/3_2.jpg" data-tooltip="Orange"><span style="background-color:#76e7e7;"></span></a></li>
                                                </ul>
                                            </div>
                                            <div class="ec-pro-compare">
                                                <a href="compare.html" class="ec-btn-group compare" title="Compare"><img src="assets/images/icons/compare_5.svg" class="svg_img pro_svg" alt="" /></a>
                        ...
                        <div class="ec-product-content">
                            <div class="ec-product-inner">
                                ...
                                <div class="ec-pro-image-outer">
                                    <div class="ec-pro-image">
                                        <a href="product-left-sidebar.html" class="image">
                                            <img class="main-image" style="height:216px;" src="assets/images/exclusive-products/samsung_galaxy800.jpg" alt="Product" />

                                            <img class="hover-image" style="height:216px;" src="assets/images/exclusive-products/samsung_galaxy800.jpg" alt="Product" />
                                ...
                                <div class="ec-pro-content">
                                    <div class="ec-pro-option">
                                        <div class="ec-pro-opt-inner">
                                            <div class="ec-pro-color">
                                                <ul class="ec-opt-swatch ec-change-img">
                                                    <li class="active"><a href="#" class="ec-opt-clr-img" data-src="assets/images/exclusive-products/samsung_galaxy800.jpg" data-src-hover="assets/images/exclusive-products/samsung_galaxy800.jpg" data-tooltip="Gray"><span style="background-color:#202020;"></span></a></li>


                                                </ul>
                                            </div>
                                            <div class="ec-pro-compare">
                                                <a href="compare.html" class="ec-btn-group compare" title="Compare"><img src="assets/images/exclusive-products/samsung_galaxy800.jpg" class="svg_img pro_svg" alt="" /></a>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="ec-product-content">
                            <div class="ec-product-inner">
                                ...
                                <div class="ec-pro-image-outer">
                                    <div class="ec-pro-image">
                                        <a href="product-left-sidebar.html" class="image">
                                            <img class="main-image" style="height:216px;" src="assets/images/exclusive-products/speaker.jpg" alt="Product" />


                                            <img class="hover-image" style="height:216px;" src="assets/images/exclusive-products/speaker.jpg" alt="Product" />
                                ...
                                <div class="ec-pro-content">
                                    <div class="ec-pro-option">
                                        <div class="ec-pro-opt-inner">
                                            <div class="ec-pro-color">
                                                <ul class="ec-opt-swatch ec-change-img">
                                                    <li class="active"><a href="#" class="ec-opt-clr-img" data-src="assets/images/exclusive-products/speaker.jpg" data-src-hover="assets/images/exclusive-products/speaker.jpg" data-tooltip="Gray"><span style="background-color:#dfdfdf;"></span></a></li>
                                ...
                                <div class="ec-footer-links">
                                    <ul class="align-items-center">
                                        <li class="ec-footer-link">
                                            <span class="call-img"><img src="assets/images/icons/call_5.svg" class="svg_img foo_img" alt="" /></span>
                        ...
                        <div class="col-sm-12 col-lg-4 ec-footer-news">
                                    ...
                                    <div class="ec-subscribe-form">
                                        <form id="ec-newsletter-form" name="ec-newsletter-form" method="post" action="#">
                                            <div id="ec_news_signup" class="ec-form">
                                                <input class="ec-email" type="email" required="" placeholder="Enter your email" name="ec-email" value="" />
                                                <button id="ec-news-btn" class="button btn-primary" type="submit" name="subscribe" value="">subscribe</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
                            ...
                            <div class="ec-footer-widget ec-share">
                                <ul>
                                    ...
                                    <li class="ec-share-link"><a href="#"><img src="assets/images/icons/google.png" alt="" /></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
    ...
    <div class="ec-cp-style cp-right-bottom">
        ...
        <div class="cp-panel">
            ...
            <a class="cp-list" href="http://m.me/Loopinfosol" target="_blank">
                <div class="cp-image">
                    <img src="assets/images/chat-pro/cp-messenger.png" alt="" />
                </div>
            ...
            <a class="cp-list" href="https://www.instagram.com/_k_e_t_a_n_/" target="_blank">
                <div class="cp-image">
                    <img src="assets/images/chat-pro/cp-instagram.png" alt="" />
                </div>
                <div class="cp-content">
                    <h2>Instagram</h2>
            ...
            <a class="cp-list" href="https://www.linkedin.com/messaging/thread/6599949383096205313/" target="_blank">
                <div class="cp-image">
                    <img src="assets/images/chat-pro/cp-linkedin.png" alt="" />
                </div>
                <div class="cp-content">
                    <h2>LinkedIn</h2>
            ...
            <a class="cp-list" href="https://twitter.com/messages/1899733261-2826370326/" target="_blank">
                <div class="cp-image">
                    <img src="assets/images/chat-pro/cp-twitter.png" alt="" />
                </div>
                <div class="cp-content">
                    <h2>Twitter</h2>
            ...
            <a class="cp-list" href="skype:kathiriyaketan57?chat" target="_blank">
                <div class="cp-image">
                    <img src="assets/images/chat-pro/cp-skype.png" alt="" />
                </div>
                <div class="cp-content">
                    <h2>Skype</h2>
                    <p>chat on Skype</p>
            ...
            <a class="cp-list" href="viber://chat?number=+919099153528" target="_blank">
                <div class="cp-image">
                    <img src="assets/images/chat-pro/cp-viber.png" alt="" />
                </div>
                <div class="cp-content">
                    <h2>Viber</h2>
